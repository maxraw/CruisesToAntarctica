...
var _burger = require("./utils/burger");
var _yandexMap = require("./modules/yandex-map/yandex-map");
var _mapInitials = require("./modules/yandex-map/map-initials");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  burger.init();
  setTimeout(function () {
    (0, _yandexMap.initMap)({
      id: 'map',
      initials: {
        center: _mapInitials.MAP_CENTER,
        controls: [],
        zoom: _mapInitials.DEFAULT_ZOOM
      },
      placemark: [{
        hintContent: _mapInitials.PIN_INFO
      }, {
        iconImageHref: _mapInitials.PIN_IMAGE,
        iconImageSize: [18, 22],
...
},{"./modules/form-validate/form":3,"./modules/yandex-map/map-initials":9,"./modules/yandex-map/yandex-map":10,"./utils/burger":11,"./utils/ios-vh-fix":14}],2:[function(require,module,exports){
"use strict";
...
exports.PIN_LOCATION = exports.PIN_INFO = exports.PIN_IMAGE = exports.MAP_CENTER = exports.DEFAULT_ZOOM = void 0;
var MAP_CENTER = [59.938615, 30.323015];
exports.MAP_CENTER = MAP_CENTER;
var PIN_LOCATION = [59.938615, 30.323015];
exports.PIN_LOCATION = PIN_LOCATION;
var PIN_INFO = 'г. Санкт Петербург, ул. Большая Конюшенная, 19/8';
exports.PIN_INFO = PIN_INFO;
var DEFAULT_ZOOM = 16;
exports.DEFAULT_ZOOM = DEFAULT_ZOOM;
var PIN_IMAGE = 'img/svg/icon-pin.svg';
exports.PIN_IMAGE = PIN_IMAGE;
...
var _mapInitials = require("./map-initials");
...
var mapImage = document.querySelector('.contact__map-image');
...
var createMap = function createMap(_ref) {
  ...
  map.geoObjects.add(_construct(window.ymaps.Placemark, [_mapInitials.PIN_LOCATION].concat(_toConsumableArray(placemark))));
...
},{"./map-initials":9}],11:[function(require,module,exports){
"use strict";
...
},{"./focus-lock":12,"./scroll-lock":15}],12:[function(require,module,exports){
"use strict";
